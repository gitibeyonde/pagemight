...
define("MESSAGE_REGISTRATION_ACTIVATION_NOT_SUCCESSFUL", "No such id/verification code combination here. Probably you are already verified, try logging in");
define("MESSAGE_REGISTRATION_ACTIVATION_SUCCESSFUL", "Activation is successful ! You can now log in !");

...
if ($submit == "update"){
    ...
    $t = $T->saveTemplateCss($template_name, $_POST['content']);
}
else {
        	  ...
        	  <div id="headerToolbar" class="row">
                ...
                <div class="col-1">
            		<button type="submit" id="save_content" name="submit" value="update" class="btn btn-link btn-icon"
								onclick="return onClickSubmitButton('<?php echo TEMPLATE_CSS; ?>');"><span class="material-icons md-36 green">save</span></button></button>
        		...
        		<div class="col-1">
            			<a class="btn btn-sim0" href="/redirect.php?view=template_css&template_name=<?php echo $template_name; ?>"><h2>CSS</h2></a>
        		</div>
        		<div class="col-1">
